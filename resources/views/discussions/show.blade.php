...
@section('content')
	...
	<div class="panel panel-default">				
		<div class="panel-heading">
			...
			@if($d->being_watched_by_auth_user())
		...
		<div class="panel-footer">
			...
			<a href="{{ route('channel', ['slug' => $d->channel->slug]) }}" class="btn btn-default pull-right btn-xs">{{ $d->channel->title }}</a>
		</div>
	</div>
	...
	@foreach($d->replies as $r)
		<div class="panel panel-default">				
			<div class="panel-heading">
				...
				@if(!$best_answer)
					@if(Auth::id() == $d->user->id)
						<a href="{{ route('reply.best.answer', ['id' => $r->id ]) }}" class="btn btn-xs btn-success pull-right" style="margin-right: 8px;">Mark as best answer</a>
					@endif
				@endif
